# Entity Framework (EF) – Interview Notes
...
**Simple definition:**  
Entity Framework acts as a bridge between **C# classes** and **database tables**.

---

## Why Entity Framework is used?
Without Entity Framework, developers must:
- Write SQL queries
- Open and manage database connections
- Read data row by row
- Manually map database columns to C# objects

Entity Framework handles all this automatically and reduces boilerplate code.
